    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="button_list d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <button type="button" class="button-blue bingo_button middle_button"
                                    ...
                                    data-url="<?= Helper::getUrl("/upload/image") ?>">
                ...
                <div class="row no-gutters file-list my-4 files-table">
                    <?php
                    foreach ($data['pageData']['rows'] as $row) : ?>
                        ...
                        ?>
                        <div class="col-md-3 col-lg-2 input-image">
                            <div class="box image">
                                ...
                                <div class="thumb image-thumb">
                                    <a href="<?= $row['link'] ?>" data-fancybox="gallery"
                                       title="<?= $filename ?>">
                                        <img src="<?= Helper::thumb($row['link']) ?>" data-src="<?= $row['link'] ?>"
                                             alt="<?= $filename ?>">
                                    </a>
