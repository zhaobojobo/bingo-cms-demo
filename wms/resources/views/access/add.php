...
<main class="pb-3">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="<?= Helper::getUrl('/accesses/create') ?>" id="form" class="mt-4">
                            ...
                            <div class="row pb-4 pb-lg-0">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="input-block p-2">
                                        ...
                                        <input type="text" name="route" id="route" class="input_normal" value="">
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div class="input-block p-2">
                                ...
                                <div class="col-md-6 col-lg-2">
                                    <div class="input-block p-2">
                                        ...
                                        <select name="access_type" id="access_type" class="input_normal">
                                            <option value="0"><?= Helper::_('None') ?></option>
                                            <option value="1"><?=Helper::_('Create')?></option>
                                            <option value="2"><?=Helper::_('Update')?></option>
                                            <option value="3"><?=Helper::_('Read')?></option>
                                            <option value="4"><?=Helper::_('Delete')?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-2">
